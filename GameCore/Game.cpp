...
//	models.push_back(new Model("./models/Room/Room #1.obj"));
//
...
//		it->setPosition(this->CameraGetPosition());
//		it->setDirection(this->CameraGetDirection());
//	});
//
...
//}
//glm::vec3 Game::CameraGetDirection() {
//	glm::vec3 direction = this->camera->Orientation * (-this->camera->Forward);
//	//logger.Debug("Direction: x: %f, y: %f, z: %f", direction.x, direction.y, direction.z);
//	return direction;
//}